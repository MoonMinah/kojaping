    ...
    <div class="reservation-list">
        ...
        <table class="table table-bordered text-center"> <!-- 테이블 텍스트 중앙 정렬 -->
            ...
            <c:forEach var="reservation" items="${reservations}">
                ...
                <!-- 리뷰 작성 모달 2 -->
                <div class="modal fade" id="reviewModal-2" tabindex="-1" role="dialog">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">리뷰 작성 - Cozy Cottage</h5>
                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                            </div>
                            <form action="/submitReview" method="post">
                                <div class="modal-body">
                                    <div class="form-group">
                                        <label for="rating-2">별점</label>
                                        <select class="form-control" name="rating" id="rating-2">
                                    ...
                                    <div class="form-group">
                                        <label for="review-2">리뷰 내용</label>
                                        <textarea class="form-control" name="reviewContent" id="review-2" rows="3"></textarea>
                                    </div>
                                </div>
                                <div class="modal-footer">
