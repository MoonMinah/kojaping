...
public class MainController {
    ...
    public String selectRoom(
        ...
        // 4. Elasticsearch에서 주소 검색
        List<Accommodation> productsFromElasticsearch = productService.searchProductsByAddress(address);

        // 제품 주소 추출
        List<String> productIds = productsFromElasticsearch.stream()
    ...
    @ResponseBody
    public List<Accommodation> searchAddress(@RequestParam String address) {
        // Elasticsearch에서 주소로 검색
        List<Accommodation> accommodations = productService.searchProductsByAddress(address);
        return accommodations; // JSON 형태로 반환
    }
...
*/
    ...
    public String paymentOk(@RequestParam Map<String, Object> params, Model model,
        ...
        if (params.get("paymentStatus").equals("성공")) {
            ...
            // 결제 완료 정보 모델로 전달
            payment = paymentMapper.selectPaymentDetail(paymentId);
